        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadowshadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                    <h3 className="text-xl font-bold mb-2">Full Stack Developer — Área de Tecnología (TI) </h3>

                     <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <strong>Universal de Servicios Asociados S.A.S | 01/2023 – 07/2025</strong>
                            <p className="text-gray-400">
                                Participé en el desarrollo e implementación de soluciones tecnológicas internas,
                                contribuyendo al diseño, desarrollo y mantenimiento de sistemas empresariales a lo
                                largo de todo el stack, asegurando la estabilidad de los sistemas en producción.
                            </p>
                        <li>
                            Desarrollo de aplicaciones frontend y backend para plataformas internas.
                        </li>
                        <li>
                            Diseño e implementación de APIs REST y servicios backend escalables.
                        </li>
                        <li>
                        ...
                        <li>
                            Identificación y resolución de errores en producción, mejorando la estabilidad del sistema.
                        </li>
                        <li>
                            Aplicación de buenas prácticas de desarrollo y principios de arquitectura de software.
                        </li>
                        <li>
                    ...
                    <div className="w-full flex flex-wrap gap-2 justify-center mt-4">
                        {["JavaScript", "Next.js", "Angular", "NestJS", "Java", "Spring Boot", "Go", "PostgreSQL", "MySQL", "MongoDB", "AWS", "Git"].map((tech, key) => (
                            <span
                            key={key}
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadowshadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                    ...
                    <p className="text-gray-400">
                     <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <strong> Factech Group S.A.S | 10/2025 – 03/2026 </strong>
                        <li>
